...
# SPECIFICATION: test the accuracy of different single and multi-layer perceptrons
...
highest_single_accuracy = 0  # store best accuracy of classifiers to update when new best found
...
for w in n:  # iterates over n
    ...
    for b in r:  # iterates over r
        ...
        for a in range(2):  # iterates over the algorithms
            ...
            # --> add your Python code here
            if a == 0 and (correct / len(X_test)) > highest_single_accuracy:
                highest_single_accuracy = correct / len(X_test)
                print(f"Highest Perceptron accuracy so far: {highest_single_accuracy}, Parameters: learning rate={w}, shuffle={b}")

            if a == 1 and (correct / len(X_test)) > highest_multi_accuracy:
                highest_multi_accuracy = correct / len(X_test)
                print(f"Highest MLP accuracy so far: {highest_multi_accuracy}, Parameters: learning rate={w}, shuffle={b}")
